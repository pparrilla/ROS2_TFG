...
class TemperatureHumidityNode(Node):
    def __init__(self):
        ...
        self.declare_parameter("temperature", 22.0)
        self.declare_parameter("humidity", 10.0)
        self.declare_parameter("pos_x", 0.0)
        self.declare_parameter("pos_y", 0.0)

        self.temperature_msg_ = FloatDataNode()
        self.temperature_msg_.device_id = self.get_parameter("device_id").value
        self.temperature_msg_.data = self.get_parameter("temperature").value
        ...
        self.humidity_msg_.device_id = self.get_parameter("device_id").value
        self.humidity_msg_.data = self.get_parameter("humidity").value
        ...
        self.sensor_timer_ = self.create_timer(20.0, self.publish_temperature_data)
        self.sensor_timer_ = self.create_timer(20.0, self.publish_humidity_data)
